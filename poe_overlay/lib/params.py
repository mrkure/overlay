...
params = {
        ...
        'health_bar_css' : "background-color: rgba(14, 255, 255, 210);"
                           "font: 18 24pt \"MS Shell Dlg 2\";",                # fontsize - XXpt
                           
        'stopwatch_geo' : [340,950,80,30],
        'stopwatch_css' : "background-color: rgba(14, 255, 255, 210);"
                           "font: 18 14pt \"MS Shell Dlg 2\";",                # fontsize - XXpt 
                           
                           
                           
        'button_inactive': "background-color: rgba(240, 240, 240, 255)" ,
        'button_active':   "background-color: rgba(14, 255, 255)"  ,                 
        }
